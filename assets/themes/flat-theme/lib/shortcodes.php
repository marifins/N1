...
add_shortcode( 'zee_team', function( $atts, $content = null ){
  ...
  <div class="team-list">
    ...
    <a href="#" class="<?php if($i==1) { ?>col-lg-4 col-md-4 col-sm-4<?php } else { ?>col-lg-2 col-md-2 col-sm-2<?php } ?> center">
  ...
  <div class="team-member">
    <?php $i=1; foreach ($data as $key => $value) { ?>
    <div class="team row <?php if($i!=1){ ?>hidden-lg hidden-md hidden-sm<?php } ?>">
