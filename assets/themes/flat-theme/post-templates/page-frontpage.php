...
<!--
        ...
        <ul class="thumbnails">
          ...
          <li class="<?php echo $span; ?>">
            <div class="news-thumb">
              ...
              <a class="thumbnail" href="<?php the_permalink(); ?>" <?php echo 'style="background-image: url('.$imgurl.')"'; ?>></a>
    ...
    <div class="row" style="text-align:center;">
      <div class="col-sm-12">
          <a href="<?php echo get_home_url(); ?>/category/berita/">
            <div id="link-box-green">Berita Selengkapnya...</div>
          </a>
      </div>
    </div>
	  </div>
    ...
    <!--- Bisnis Perusahaan --->
    <?php
      get_template_part('bisnis','perusahaan');
    ?>
    <!------------------------>

    <!--- Unit Usaha (Google Map) --->
    <?php
      get_template_part('unit','usaha');
    ?>
    <!------------------------>

    <!--- CSR --->
    <?php
      get_template_part('csr');
    ?>
    <!------------------------>
    ...
    <section id="bumn-perkebunan">
      <div class="container">
        <div class="row">
          <h2><i>Holding</i> BUMN Perkebunan</h2>
